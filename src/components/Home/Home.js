...
const descriptionText = `Если Вы планируете комфортно разместиться после долгой дороги, приглашаем в гостиницу «Дом у дороги», интерьеры комнат сочетают в себе традиции русского барокко и элементы современной архитиктуры. \n` +
    `Гостиница идеально расположена для встрече уставших путников. К услугам гостей предлагаются изысканные люксы и современные номера, которые обеспечат приятный отдых и комфортную обстановку для работы. \n` +
...
const Home = () => {
    return (
        <div className="block">
            ...
            <div className="block-description"> {/*className="block-description"*/}
